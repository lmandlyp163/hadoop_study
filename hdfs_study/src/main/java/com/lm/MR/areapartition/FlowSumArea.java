package com.lm.MR.areapartition;

import com.lm.MR.flowsum.FlowBean;
...
public class FlowSumArea {
	...
	public static void main(String[] args) throws Exception {
		...
		//设置reduce的任务并发数，应该跟分组的数量保持一致(这样能保证每个组到一个reduce中)
		// 如果ReduceTasks 数大于分组数 会出现一些reduce 没有数据执行
		// 如果ReduceTasks 数小于分组数 会出现报错，因为不知把多的组发给谁（除了设置为1）
